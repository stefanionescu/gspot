...
| `baselines.ts`   | gspot's count files; drives ESLint suppressions and basedpyright's baseline (D-54); `apply --lower-baselines`                                                               |
...
| `commits`                                                                        | `commitlint.config.cjs.tmpl`                                                                                                                                                                                     |
...
| `security`                                                                       | `semgrep/secrets.yml`, `semgrep/vendor/` (the pinned upstream OWASP, python, bash and secrets sets, one file each), `codeql/` (`javascript.yml`, `python.yml`, `swift.yml` query suites)                         |
