...
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | --------------------------------------------------------- |
| Generated configuration | `.gspot/*` equals its render from `gspot.toml`                                                                                               | `integrity/generated-drift` (`apply --check`)                 | commit                                                    |
...
| Rule files              | the installed rule files equal the assembled render; every statement's `enforced-by` names a check that exists                               | `apply --check`                                               | push                                                      |
| Agent index             | the managed block in `CLAUDE.md` and `AGENTS.md` matches the installed files                                                                 | `apply --check`                                               | commit                                                    |
