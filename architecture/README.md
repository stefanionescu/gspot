...
| [07-slop-and-drift.md](07-slop-and-drift.md) | New enforcement: what LLM slop and repository drift look like and how gspot catches them |
...
Read 01 to 05 to understand the tool. Read 06 to 09 to understand the rules. Read 10 to 16 to
build it.
...
- A number that summarises a list lives beside the list, or not at all.
