...
Last reviewed: 2026-09-20, source `7af4d7134e60e6752cf62f39df4507338fda184e`.

| Area                              | Current status and outstanding acceptance                                                                                                                           |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase 0                           | Implemented; lifecycle safety, canonical commands, ownership and recovery remain open (G-2, K-298–K-300).                                                           |
| ESLint, JavaScript and TypeScript | Implemented; takeover, compatible pins, levels and component coverage remain open (K-101, K-207, K-208, K-217).                                                     |
| Naming and structure              | Implemented; layout assumptions, false positives and usefulness remain open (K-149, K-186, K-189, K-301).                                                           |
| Prose and rule files              | Implemented; contradictory rules, defaults and enforcement remain open (K-230–K-232, K-241, K-242).                                                                 |
| Integrity checks                  | Implemented; destructive checks and failed observations remain open (K-156, K-257, K-307).                                                                          |
| Self-check                        | Historical green runs exist; coverage, templates and documentation verification remain open (S-1–S-19). CI is currently bypassed.                                   |
| Test harness                      | Implemented; naming a check in a test does not prove defect detection. Setup, meaningful assertions and package installation remain open (T-24, T-27, T-28, K-310). |
| Hardening                         | Partial. Timeouts, safe lifecycle mutation, recovery and installation are not accepted (K-263, K-264, K-298, K-299).                                                |
| Framework phases                  | 48 presets exist. Presence does not establish enforcement completeness; framework and ledger acceptance remain open (K-211, K-248).                                 |
| Yap adoption                      | Final packaged adoption is not accepted. Keep Yap unchanged until the handoff prerequisites are met.                                                                |
| Documentation and release         | Guides and build scripts exist. Artwork, website review, seven-target packaging and release acceptance remain open (G-10, K-164, K-263, K-280, K-302).              |
...
| `gspot declare` and six of the seven lists of `gspot allow`                                                                                                                                                            | `commands/`, `policy/`                                                                    |
| `uninstall --keep-hooks`, `apply --check`                                                                                                                                                                              | `commands/`                                                                               |
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| Delete what nothing uses                                    | K-111, K-115, K-119, K-146, K-180, K-205, K-240, K-259, K-282, K-290                                                                                                                        | Delete first                                         |
...
| Speed                                                       | K-71, K-127, K-138, K-143, K-148, K-162, K-176, K-196                                                                                                                                       | 3 and 21                                             |
...
| The config and its words                                    | K-88, K-89, K-215, K-222, K-224, K-225, K-228                                                                                                                                               | 8 and 18                                             |
...
before deleting the old app branch. Follow the [active CI bypass](22-remaining.md#active-ci-bypass):
CI evidence is deferred until the user explicitly re-enables CI.
