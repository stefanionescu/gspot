...
| Phase 1, the rest                     | Done: the commits and config-files presets, ESLint suppression baselines (D-54), `upgrade` with its report. Owed: the takeover planted test, the docs site.                                                                                                                                                                                                                                            |
