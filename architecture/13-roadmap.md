...
| Phase 1, the rest                     | Done: the commits and config-files presets, ESLint suppression baselines (D-54), `upgrade` with its report, the takeover planted test. Owed: the docs site.                                                                                                                                                                                                                                            |
