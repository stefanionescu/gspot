...
| Phase 1, the rest                     | Done: the commits preset. Owed: the config-files preset, ESLint suppression baselines (D-54), `upgrade` between versions, the takeover planted test, the docs site.                                                                                                                                          |
