...
| Phase 1, the rest                     | Done: the commits and config-files presets. Owed: ESLint suppression baselines (D-54), `upgrade` between versions, the takeover planted test, the docs site.                                                                                                                                                 |
