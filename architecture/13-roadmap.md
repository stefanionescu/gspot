...
| Structure engine                      | Done for directories, shell, and Python (twelve `python/*` checks, D-98), with a planted defect for every check. SQL has `sql/block-comments` and `sql/file-length`. The Swift analyses are owed (Stage D of the build plan).                                                                                                                                                                                                                                                                                                                                                                              |
