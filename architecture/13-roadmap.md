...
| `gspot declare`, `gspot profile check`, and six of the seven lists of `gspot allow`                                                                                                                                    | `commands/`, `policy/`                                                                    |
| `doctor --offline`, `uninstall --keep-hooks`, `--dry-run` on `ignore` and `set`, `apply --check`                                                                                                                       | `commands/`                                                                               |
