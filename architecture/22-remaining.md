...
Outstanding implementation includes the remaining session consumers, shared catalog preparation,
...
| `packages/cli/src/adoption/collect.ts`                                    | Moved                 | Feature owns the behavior from `lifecycle/takeover.ts` without forwarding.         |
| `packages/cli/src/adoption/eslint.ts`                                     | Moved                 | Feature owns the behavior from `lifecycle/carry-eslint.ts` without forwarding.     |
| `packages/cli/src/adoption/formatting.ts`                                 | Moved                 | Feature owns the behavior from `lifecycle/carry-formatting.ts` without forwarding. |
| `packages/cli/src/adoption/native.ts`                                     | Simplified            | Prepare native validation and converter registration once.                         |
| `packages/cli/src/adoption/source.ts`                                     | Moved                 | Feature owns the behavior from `lifecycle/carry-source.ts` without forwarding.     |
...
Source and retained evidence: [packages/cli/src/adoption/collect.ts](../packages/cli/src/adoption/collect.ts), [tests/acceptance/source/cli/takeover.test.ts](../tests/acceptance/source/cli/takeover.test.ts).
...
Source and retained evidence: [packages/cli/src/program.ts](../packages/cli/src/program.ts), [tests/acceptance/source/cli/profile.test.ts](../tests/acceptance/source/cli/profile.test.ts).
...
Source and retained evidence: [packages/cli/src/emit/managed-blocks.ts](../packages/cli/src/emit/managed-blocks.ts), [tests/acceptance/source/cli/lifecycle.test.ts](../tests/acceptance/source/cli/lifecycle.test.ts).
...
Source and retained evidence: [packages/cli/src/emit](../packages/cli/src/emit), [tests/acceptance/source/cli/hooks.test.ts](../tests/acceptance/source/cli/hooks.test.ts).
...
Source and retained evidence: [packages/cli/release/publish.ts](../packages/cli/release/publish.ts), [tests/acceptance/release/install.test.ts](../tests/acceptance/release/install.test.ts).
...
Source and retained evidence: [packages/cli/src/emit/targets.ts](../packages/cli/src/emit/targets.ts), [tests/acceptance/source/cli/attributes.test.ts](../tests/acceptance/source/cli/attributes.test.ts).
