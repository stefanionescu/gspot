...
| `integrity/required-rules`   | push   | `eslint --print-config` for one file per ending, compared with the `[required_rules]` of every selected manifest (D-99); shipped by `javascript`                                                                                                                                                            |
