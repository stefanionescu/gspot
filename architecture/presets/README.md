...
| --- | --- | --- | --- |
| typescript | `.ts`, `tsconfig.json` | tsc, ESLint with typescript-eslint and eslint-plugin-gspot, knip | [typescript.md](typescript.md) |
...
| vulnerabilities | proposed | Semgrep, CodeQL | [vulnerabilities.md](vulnerabilities.md) |
...
| Express API, Supabase, iOS app in one monorepo | scope `api`: typescript, express, docker, nginx, vitest; scope `supabase`: typescript, sql, postgres, supabase; scope `ios`: swift, xcode; root: bash, markdown, and the defaults |
