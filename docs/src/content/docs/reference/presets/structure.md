...
| [`integrity/suppressions`](/reference/rules/integrity/suppressions/)                         | commit | Checks suppression reasons when require_reasons is enabled; nosemgrep is refused outright.                                                                |
