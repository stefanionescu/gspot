...
- `format.overrides`: Ordered formatting options for config-root paths, bounded by their declaring scope. Apply regenerates EditorConfig for current governed files.
