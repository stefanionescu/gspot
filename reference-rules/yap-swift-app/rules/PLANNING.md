...
These rules apply whenever an agent creates any implementation plan, migration
plan, refactor plan, documentation plan, UI plan, asset plan, or other planned
change sequence.
