...
import { PRETTIER_IGNORE_FILES, PRETTIER_IGNORE_SOURCE } from '#tests/constants/acceptance/source/cli/cli.ts';
...
test(
    ...
    async () => {
        ...
        const corrected = await run(repository.path, [...args, ...PRETTIER_IGNORE_FILES]);
