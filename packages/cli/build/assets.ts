...
function assetKey(file: string): string {
    const key = grammarAssets.get(file) ?? (file === join(here, '.build/configuration-process.js') ? 'packages/cli/build/configuration-process.js' : relative(root, file));
...
export function writeEntry(): string {
    ...
    const lines = [
        '// Generated by bun packages/cli/build/command.ts. Do not edit.',
        ...imports,
