...
test.each([
    ...
    async (manager, projectPath, runner) => {
        ...
        try {
            ...
            await expect(installPackageProject(repository.path)).rejects.toThrow(
...
`;
            ...
            await expect(installPackageProject(repository.path)).rejects.toThrow('scripts');
            ...
            } else installed = await installPackageProject(repository.path);
            ...
            await expect(installPackageProject(repository.path)).rejects.toThrow('Preserved edited');
            ...
            await installPackageProject(repository.path);
