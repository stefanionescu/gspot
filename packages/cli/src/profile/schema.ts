...
export const REPOSITORY_TABLES = ['scope', 'ignore', 'declare', 'check'] as const;

/** A profile as written. */
export const profileSchema = policySchema.omit({ scope: true, ignore: true, declare: true, check: true }).extend({
