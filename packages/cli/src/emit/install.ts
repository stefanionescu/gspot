...
import { selectForInit } from '#cli/emit/selection.ts';
import { detectionText } from '#cli/output/detection.ts';
import { readRepository } from '#cli/repository/tree.ts';
import { askInitQuestions } from '#cli/emit/questions.ts';
...
import { buildInitPlan, buildProposal } from '#cli/emit/init-plan.ts';
import { existingTooling } from '#cli/repository/existing-tooling.ts';
import type { InitOptions, InitPrepared, InitResult } from '#types/emit.ts';
import { applyBlock, gitignoreBlock, fileText } from '#cli/emit/managed-blocks.ts';
import { collectCarried, deleteReplaced, ownedTools, unownedTools } from '#cli/emit/takeover.ts';
import { firstRun, firstRunSummary, installTools, updatePackageJson } from '#cli/emit/first-run.ts';
