...
import type { Analysis, ShellFunction } from '#types/structure.ts';
 ...
 */
export const duplicateFunctions: Analysis = async (context, shell) => {
    ...
    const add = (file: string, entry: ShellFunction): void => {
