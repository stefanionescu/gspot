...
import { carryFrom } from '#cli/adoption/native.ts';
import { collectEslint } from '#cli/adoption/eslint.ts';
import type { CarriedConfiguration } from '#cli/adoption/native.ts';
import { collectFormatting } from '#cli/adoption/formatting.ts';
...
import { observeConfiguration, parseCarrySource } from '#cli/adoption/source.ts';
