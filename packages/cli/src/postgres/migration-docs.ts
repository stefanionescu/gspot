...
import { positionAt } from '#cli/sql/statements.ts';
import { migrationsOf } from '#cli/postgres/migrations.ts';
import type { DocProblem, Migration } from '#types/postgres.ts';
import { DOC_SECTIONS, DOC_SEPARATOR, STATEMENT_WORDS } from '#config/postgres.ts';
