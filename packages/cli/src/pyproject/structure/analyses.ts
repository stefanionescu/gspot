...
import { importCycles, singletons } from '#cli/pyproject/structure/imports.ts';
import { functionsOf, pythonModules } from '#cli/pyproject/structure/modules.ts';
...
import {
    ...
    privateBeforePublic,
    privatePrefixes,
} from '#cli/pyproject/structure/exports.ts';
import {
    callThroughs,
    longFunctions,
    longModules,
    ...
    trivialFunctions,
} from '#cli/pyproject/structure/functions.ts';
