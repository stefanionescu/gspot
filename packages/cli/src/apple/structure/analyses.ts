...
import { functionsOf, swiftSources } from '#cli/apple/structure/sources.ts';
import { environmentReads, privateBeforePublic } from '#cli/apple/structure/order.ts';
import { callThroughs, duplicateFunctions, trivialFunctions } from '#cli/apple/structure/bodies.ts';
