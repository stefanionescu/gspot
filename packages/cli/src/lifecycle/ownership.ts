...
import { configurationFieldsSchema, ownershipSchema } from '#cli/lifecycle/journal.ts';
...
export type LifecycleOwner = {
    ...
    proposeBlock(path: string, body: string, style: import('#cli/emit/managed-blocks.ts').BlockStyle): FileProposal;
    ...
    replaceBlock(
        path: string,
        body: string,
        style: import('#cli/emit/managed-blocks.ts').BlockStyle,
